        ...
        <div className="card card-compact w-[100%] bg-base-100 shadow-xl mb-5">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
                ...
                <div>
                    <p className="text-sm md:text-2xl font-bold ">{author}</p>
          ...
          <div className="card-body text-left">
            ...
            <button className="underline text-left text-violet-500 " onClick={()=>handleMarkAsRead(reading_time ,id)}>Mark as read</button>
          </div>
        </div>
      </div>
    </div>
